...
<div class="admin-stat-grid">
  <div class="admin-stat-card analytics-online-card">
    <div class="analytics-online-head">
      ...
      <div class="admin-stat-value" style="margin-bottom:0;">{{ $onlineCount }}</div>
    </div>
    <div class="admin-stat-label">Conectados ahora</div>
    <div class="analytics-online-list">
      @foreach($onlineVisitors as $v)
        <div class="analytics-online-row"><span class="p">{{ $v['page'] }}</span><span class="t">{{ $v['hace'] }}</span></div>
      @endforeach
    </div>
  </div>
