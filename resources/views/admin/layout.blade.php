  ...
  <aside class="admin-sidebar" :class="{ 'is-open': navOpen }">
    ...
    @php
      $navGroups = [
        'catalogo' => [
          'label' => 'Catálogo',
          'match' => ['admin.productos.*', 'admin.categorias.*', 'admin.promociones.*', 'admin.combos.*', 'admin.descuentos.*', 'admin.woocommerce.*', 'admin.attribute-fields.*', 'admin.pc-builder-options.*'],
        ],
        'contenido' => [
          'label' => 'Contenido',
