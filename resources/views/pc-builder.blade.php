...
<div class="wrap"
     x-data="{
        ...
        stepHints: @js([
          ...
          'cpu' => 'El procesador (o "CPU") es el que piensa y calcula todo — es como el cerebro de tu PC. Cuánto más potente, más rápido corre todo: juegos, programas, tener muchas cosas abiertas a la vez.',
          'motherboard' => 'La placa madre es donde se conecta físicamente todo lo demás (procesador, memoria, tarjeta gráfica) — como el esqueleto de la PC. Ya te filtramos las que sí funcionan con el procesador que elegiste, no hace falta que sepas más.',
          'ram' => 'La memoria RAM es donde tu PC va guardando, mientras está prendida, todo lo que estás usando en ese momento — como tu mesa de trabajo. Cuánta más tenés, más cosas podés tener abiertas a la vez (un juego + Discord + el navegador) sin que se ponga lento.',
          'storage' => 'Acá se guarda todo para siempre, aunque apagues la PC: el sistema, tus juegos, tus fotos y archivos — a diferencia de la RAM, esto no se borra nunca solo. Un SSD NVMe hace que todo cargue mucho más rápido que un disco duro tradicional.',
          'gpu' => 'La tarjeta gráfica ("GPU") es la que dibuja lo que ves en pantalla — mientras mejor sea, mejores gráficos y más fluido corren los juegos. Es la pieza que más define qué tan bien vas a poder jugar.',
          'psu' => 'La fuente de poder le da electricidad a todo el equipo — como el corazón que bombea energía a cada pieza. Si es muy débil para lo que elegiste, el equipo puede apagarse solo o no prender del todo; te avisamos si la que elegiste no alcanza.',
          'case' => 'El gabinete es la "caja" que contiene y protege todo por dentro — tiene que tener espacio de sobra para tu placa madre, tu tarjeta gráfica y el enfriamiento que elijas.',
          'cooler' => 'El enfriamiento evita que el procesador se recaliente cuando la PC trabaja fuerte (jugando, editando video). Sin uno adecuado, la PC se hace más lenta a propósito para protegerse del calor, o se puede apagar sola.',
        ]),
